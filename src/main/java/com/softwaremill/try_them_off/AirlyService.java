...
class AirlyService {
  ...
  Try<Measurements> getMeasurement(GeoCoordinates coordinates) {
    final Function<String, RawMeasurements> stringRawMeasurementsFunction = responseBody -> new RawMeasurements(coordinates.city(), responseBody);
  ...
  private Measurements parse(RawMeasurements raw) throws IOException, IllegalArgumentException {
